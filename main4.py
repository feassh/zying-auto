...
#         ctypes.windll.user32.SetWindowPos(hwnd, 0, 0, 700, 1110,
#                                           screen_height - 700 - util.system.get_windows_app_bar_height(), 0x4)
#     else:
...
#                 util.system.print_inline(f"当前选择的配送地址：{country} {state} {city} {district}", color="green")
#             except:
#                 pass
#
...
#         util.system.show_toast("程序发生未预料的严重错误！已结束运行。")
#         util.app.press_any_key_exit()
